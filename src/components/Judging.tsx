...
export const Judging: React.FC = () => {
  ...
  return (
    <section id="judging" className="py-16 sm:py-24 bg-black relative border-t border-white/5">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6">
          {JUDGING_CRITERIA.map((criterion, idx) => (
            <motion.div
              ...
              className="p-5 sm:p-6 rounded-2xl bg-[#0F0F14] border border-white/10 relative overflow-hidden group hover:border-[#FFD400]/50 hover:shadow-[0_0_25px_rgba(255,212,0,0.15)] transition-all flex flex-col justify-between"
            >
              <div>
                <div className="flex items-center justify-between mb-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl bg-[#FFD400]/10 border border-[#FFD400]/20 flex items-center justify-center">
                    {getIcon(idx)}
                  </div>
                  <span className="font-heading font-black text-xl sm:text-2xl text-[#FFD400] px-2.5 sm:px-3 py-0.5 sm:py-1 rounded-xl bg-black border border-[#FFD400]/30 shadow-inner">
