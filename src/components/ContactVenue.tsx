...
export const ContactVenue: React.FC = () => {
  ...
  return (
    <section id="contact" className="py-16 sm:py-24 bg-[#070709] relative border-t border-white/5">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10">
          ...
          <div className="space-y-6">
            <div className="p-5 sm:p-8 rounded-3xl bg-[#0F0F14] border border-white/10 space-y-6">
              ...
              <div className="space-y-4 pt-2">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div className="min-w-0">
                    ...
                    <a href={`mailto:${HACKATHON_DETAILS.contactEmail}`} className="text-xs sm:text-sm text-[#FFD400] font-semibold hover:underline truncate block">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <a href={`tel:${HACKATHON_DETAILS.contactPhone}`} className="text-xs sm:text-sm text-gray-200 font-medium">
            ...
            <div className="h-56 sm:h-64 rounded-3xl overflow-hidden border border-white/10 relative shadow-xl group">
              <iframe
              ...
              <div className="absolute bottom-3 right-3 sm:bottom-4 sm:right-4 z-10">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-3 sm:px-4 py-2 sm:py-2.5 rounded-xl bg-black/90 hover:bg-[#FFD400] text-white hover:text-black border border-white/20 text-[11px] sm:text-xs font-extrabold flex items-center gap-1.5 sm:gap-2 shadow-2xl backdrop-blur-md transition-all active:scale-95"
                >
                  <MapPin className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#FFD400] group-hover:text-black" />
          ...
          <div className="p-5 sm:p-8 rounded-3xl bg-[#0F0F14] border border-white/10 relative">
            ...
            {formSubmitted ? (
              <motion.div
                ...
                className="p-6 sm:p-8 text-center bg-[#FFD400]/10 border border-[#FFD400]/40 rounded-2xl my-6 sm:my-8 space-y-3"
              >
                <CheckCircle2 className="w-10 h-10 sm:w-12 sm:h-12 text-[#FFD400] mx-auto" />
                <h4 className="font-heading font-bold text-lg sm:text-xl text-white">Message Sent Successfully!</h4>
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full px-4 py-3 rounded-xl bg-black border border-white/10 text-white placeholder-gray-600 focus:outline-none focus:border-[#FFD400] text-base sm:text-sm resize-none"
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full py-3.5 rounded-xl bg-[#FFD400] text-black font-extrabold text-xs uppercase tracking-wider shadow-lg shadow-[#FFD400]/20 hover:bg-[#FFE033] disabled:opacity-50 transition-all flex items-center justify-center gap-2 min-h-[44px]"
                >
                  {isSubmitting ? (
                    <>
