...
export const Schedule: React.FC = () => {
  ...
  return (
    <section id="schedule" className="py-16 sm:py-24 bg-black relative border-t border-white/5">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex justify-center mb-8 sm:mb-10">
          <div className="p-1 sm:p-1.5 rounded-2xl bg-[#0F0F14] border border-white/10 flex items-center gap-1 sm:gap-2 max-w-full overflow-x-auto">
            <button
              onClick={() => setActiveDay('day1')}
              className={`px-3.5 sm:px-6 py-2.5 sm:py-3 rounded-xl text-xs sm:text-sm font-extrabold uppercase tracking-wider transition-all whitespace-nowrap min-h-[44px] ${
                activeDay === 'day1'
        ...
        <div className="space-y-3 sm:space-y-4">
          {daySchedule.map((item, idx) => (
            <motion.div
              ...
              className={`p-4 sm:p-5 rounded-2xl border transition-all flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3 sm:gap-4 group ${
                item.highlight
            ...
            >
              <div className="flex flex-col sm:flex-row items-start sm:items-center gap-3 sm:gap-4 w-full">
                ...
                <div
                  className={`w-full sm:w-52 shrink-0 px-3.5 sm:px-4 py-2 sm:py-2.5 rounded-xl border font-mono text-xs font-bold text-center flex items-center justify-center gap-2 whitespace-nowrap ${
                    item.highlight
