...
export const FAQ: React.FC = () => {
  ...
  return (
    <section id="faq" className="py-16 sm:py-24 bg-black relative border-t border-white/5">
            ...
            return (
              ...
              >
                <button
                  ...
                  className="w-full p-4 sm:p-6 text-left flex items-start justify-between gap-3 sm:gap-4 min-h-[44px]"
                >
                  ...
                  <div className="p-1 sm:p-1.5 rounded-full bg-white/5 text-gray-400 shrink-0">
                    <ChevronDown
                ...
                <AnimatePresence>
                  {isOpen && (
                    <motion.div
                      ...
                      className="px-4 sm:px-6 pb-4 sm:pb-6 pt-1 text-xs sm:text-sm text-gray-300 leading-relaxed border-t border-white/5 ml-0 sm:ml-8"
                    >
                      {faq.answer && (
                        ...
                        <ul className="space-y-2">
                          {faq.points.map((pt, idx) => (
                            <li key={idx} className="flex items-start gap-2 text-gray-200">
                              <CheckCircle2 className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#FFD400] shrink-0 mt-0.5" />
                              <span>{pt}</span>
                            </li>
                          ))}
                        </ul>
