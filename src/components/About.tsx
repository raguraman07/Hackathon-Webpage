...
export const About: React.FC = () => {
  return (
    <section id="about" className="py-16 sm:py-24 bg-[#070709] relative overflow-hidden border-t border-white/5">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-10 items-stretch">
          ...
          >
            <div className="p-5 sm:p-8 rounded-2xl bg-[#0F0F14] border border-white/10 relative overflow-hidden group hover:border-[#FFD400]/40 transition-colors">
              <div className="flex items-center gap-3 sm:gap-4 mb-4">
                <img 
                  src="/corexathon-logo.png" 
                  alt="COREXATHON Logo" 
                  className="w-10 h-10 sm:w-12 sm:h-12 rounded-full object-cover border border-[#FFD400]/40 shadow-md shadow-[#FFD400]/20 shrink-0" 
                />
                <h3 className="font-heading font-bold text-xl sm:text-2xl text-white">The COREXATHON Vision</h3>
              </div>
            ...
            <div className="p-5 sm:p-8 rounded-2xl bg-[#0F0F14] border border-white/10 relative overflow-hidden group hover:border-[#FFD400]/40 transition-colors">
              <div className="flex items-center gap-3 sm:gap-4 mb-4">
                <div className="h-10 sm:h-12 px-2.5 sm:px-3 py-1 bg-white rounded-xl flex items-center justify-center shrink-0 shadow-md">
                  <img src="/sns-logo.png" alt="SNS Institutions Logo" className="h-7 sm:h-9 object-contain" />
                </div>
                <h3 className="font-heading font-bold text-lg sm:text-2xl text-white">Department of Computer Science & Engineering</h3>
              </div>
              <p className="text-gray-300 leading-relaxed text-sm sm:text-base">
          ...
          <motion.div
            ...
            className="bg-[#0F0F14] p-5 sm:p-8 rounded-2xl border border-white/10 space-y-4 sm:space-y-5"
          >
            <h3 className="font-heading font-bold text-xl sm:text-2xl text-white mb-4 sm:mb-6 flex items-center gap-2">
            ...
            {[
              ...
              <div key={idx} className="flex items-start gap-3">
                <CheckCircle2 className="w-4 h-4 sm:w-5 sm:h-5 text-[#FFD400] shrink-0 mt-0.5" />
                <span className="text-gray-300 font-medium text-xs sm:text-base">{item}</span>
              </div>
            ))}
          </motion.div>
        </div>
