...
export const Timeline: React.FC = () => {
  return (
    <section id="timeline" className="py-24 bg-black relative border-t border-white/5">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative border-l-2 border-[#1E1E28] ml-4 md:ml-32 space-y-12">
          {TIMELINE.map((item, idx) => (
            ...
            >
              ...
              <div className="md:absolute md:-left-32 md:top-1.5 md:w-28 md:text-right mb-2 md:mb-0">
                <span className="text-xs font-mono font-bold text-[#FFD400] block">
                  {item.date}
                </span>
